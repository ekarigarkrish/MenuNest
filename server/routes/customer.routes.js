...
router.post('/onbroading/send/otp', otpRequestLimiter, customerController.sendOnboardingOtp)

router.post('/onbroading/verify/otp', otpVerifyLimiter, customerController.verifyOnboardingOtp)
